...
import de.enflexit.ea.core.globalDataModel.ontology.CableWithBreakerProperties;
import de.enflexit.ea.core.globalDataModel.ontology.CircuitBreaker;
...
import de.enflexit.ea.core.globalDataModel.ontology.TriPhaseElectricalTransformerState;
import de.enflexit.ea.core.globalDataModel.ontology.TriPhaseSensorState;
...
public class CSV_FileImporterLowVoltageGrid extends CSV_FileImporter implements NetworkModelImportService{
	...
	/* (non-Javadoc)
	 * @see hygrid.csvFileImport.NetworkTopologyImporterService#setEnvironmentController(org.awb.env.networkModel.controller.GraphEnvironmentController)
	 */
	@Override
