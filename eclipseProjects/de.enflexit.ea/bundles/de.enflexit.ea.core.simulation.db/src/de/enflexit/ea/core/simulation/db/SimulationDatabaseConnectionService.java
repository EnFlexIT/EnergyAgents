...
/**
 * The Class SimulationDatabaseConnectionService provides the database connection for the Blackboard-DB.
 * 
 * @author Christian Derksen - DAWIS - ICB - University of Duisburg - Essen
 */
public class SimulationDatabaseConnectionService implements HibernateDatabaseConnectionService {

	public static final String SESSION_FACTORY_ID = "de.enflexit.ea.core.simulation.db";
	
	private static final String cfgFile = "/de/enflexit/ea/core/simulation/db/cfg/hibernate.cfg.xml";
	private static final String mappingFilesPackage = "/de/enflexit/ea/core/simulation/db/mappings/";
	...
	private static SimulationDatabaseConnectionService instance;
	public static SimulationDatabaseConnectionService getInstance() {
		if (instance==null) {
			instance = new SimulationDatabaseConnectionService();
		}
		return instance;
	}
	// --- Singleton access for the current instance ------
	 ...
	 */
	public SimulationDatabaseConnectionService() { 
		instance = this;
	}
	...
	public Bundle getLocalBundle() {
		if (localBundle==null) {
			localBundle = FrameworkUtil.getBundle(SimulationDatabaseConnectionService.class);
		}
		return localBundle;
	}
