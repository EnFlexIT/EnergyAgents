...
public class HyGridOntology extends jade.content.onto.Ontology  {
  ...
  */
  private HyGridOntology(){ 
    ...
    add(cableWithBreakerSchema, hygrid.globalDataModel.ontology.CableWithBreaker.class);
    ConceptSchema unitValueSchema = new ConceptSchema(UNITVALUE);
    add(unitValueSchema, hygrid.globalDataModel.ontology.UnitValue.class);
    ConceptSchema triPhaseElectricalTransformerStateSchema = new ConceptSchema(TRIPHASEELECTRICALTRANSFORMERSTATE);
    add(triPhaseElectricalTransformerStateSchema, hygrid.globalDataModel.ontology.TriPhaseElectricalTransformerState.class);
    ConceptSchema staticComponentPropertiesSchema = new ConceptSchema(STATICCOMPONENTPROPERTIES);
    add(staticComponentPropertiesSchema, hygrid.globalDataModel.ontology.StaticComponentProperties.class);
    ConceptSchema gridStateAssessmentSchema = new ConceptSchema(GRIDSTATEASSESSMENT);
    add(gridStateAssessmentSchema, hygrid.globalDataModel.ontology.GridStateAssessment.class);
    ConceptSchema voltageBandSchema = new ConceptSchema(VOLTAGEBAND);
    add(voltageBandSchema, hygrid.globalDataModel.ontology.VoltageBand.class);
    ConceptSchema uniPhaseElectricalTransformerStateSchema = new ConceptSchema(UNIPHASEELECTRICALTRANSFORMERSTATE);
    add(uniPhaseElectricalTransformerStateSchema, hygrid.globalDataModel.ontology.UniPhaseElectricalTransformerState.class);
    ConceptSchema pipePropertiesSchema = new ConceptSchema(PIPEPROPERTIES);
    add(pipePropertiesSchema, hygrid.globalDataModel.ontology.PipeProperties.class);
    ConceptSchema twinPipeStateSchema = new ConceptSchema(TWINPIPESTATE);
    add(twinPipeStateSchema, hygrid.globalDataModel.ontology.TwinPipeState.class);
    ConceptSchema gasNodeStateSchema = new ConceptSchema(GASNODESTATE);
    add(gasNodeStateSchema, hygrid.globalDataModel.ontology.GasNodeState.class);
    ConceptSchema fluidNodeStateSchema = new ConceptSchema(FLUIDNODESTATE);
    add(fluidNodeStateSchema, hygrid.globalDataModel.ontology.FluidNodeState.class);
    ConceptSchema activePowerSchema = new ConceptSchema(ACTIVEPOWER);
    add(activePowerSchema, hygrid.globalDataModel.ontology.ActivePower.class);
    ConceptSchema weatherDataSchema = new ConceptSchema(WEATHERDATA);
    add(weatherDataSchema, hygrid.globalDataModel.ontology.WeatherData.class);
    ConceptSchema nodeComponentStateSchema = new ConceptSchema(NODECOMPONENTSTATE);
    add(nodeComponentStateSchema, hygrid.globalDataModel.ontology.NodeComponentState.class);
    ConceptSchema electricalGridStateSchema = new ConceptSchema(ELECTRICALGRIDSTATE);
    add(electricalGridStateSchema, hygrid.globalDataModel.ontology.ElectricalGridState.class);
    ConceptSchema doubleValueSchema = new ConceptSchema(DOUBLEVALUE);
    add(doubleValueSchema, hygrid.globalDataModel.ontology.DoubleValue.class);
    ConceptSchema trafficLightSchema = new ConceptSchema(TRAFFICLIGHT);
    add(trafficLightSchema, hygrid.globalDataModel.ontology.TrafficLight.class);
    ConceptSchema uniPhaseCableWithBreakerSchema = new ConceptSchema(UNIPHASECABLEWITHBREAKER);
    add(uniPhaseCableWithBreakerSchema, hygrid.globalDataModel.ontology.UniPhaseCableWithBreaker.class);
    ConceptSchema pipeSurroundingAirSchema = new ConceptSchema(PIPESURROUNDINGAIR);
    add(pipeSurroundingAirSchema, hygrid.globalDataModel.ontology.PipeSurroundingAir.class);
    ConceptSchema heatPipePropertiesSchema = new ConceptSchema(HEATPIPEPROPERTIES);
    add(heatPipePropertiesSchema, hygrid.globalDataModel.ontology.HeatPipeProperties.class);
    ConceptSchema pipeSurroundingSchema = new ConceptSchema(PIPESURROUNDING);
    add(pipeSurroundingSchema, hygrid.globalDataModel.ontology.PipeSurrounding.class);
    ConceptSchema modbusSetpointSchema = new ConceptSchema(MODBUSSETPOINT);
    add(modbusSetpointSchema, hygrid.globalDataModel.ontology.ModbusSetpoint.class);
    ConceptSchema nodeComponentPropertiesSchema = new ConceptSchema(NODECOMPONENTPROPERTIES);
    add(nodeComponentPropertiesSchema, hygrid.globalDataModel.ontology.NodeComponentProperties.class);
    ConceptSchema cableSchema = new ConceptSchema(CABLE);
    add(cableSchema, hygrid.globalDataModel.ontology.Cable.class);
    ConceptSchema heatNodePropertiesSchema = new ConceptSchema(HEATNODEPROPERTIES);
    add(heatNodePropertiesSchema, hygrid.globalDataModel.ontology.HeatNodeProperties.class);
    ConceptSchema sensorSchema = new ConceptSchema(SENSOR);
    add(sensorSchema, hygrid.globalDataModel.ontology.Sensor.class);
    ConceptSchema edgeComponentPropertiesSchema = new ConceptSchema(EDGECOMPONENTPROPERTIES);
    add(edgeComponentPropertiesSchema, hygrid.globalDataModel.ontology.EdgeComponentProperties.class);
    ConceptSchema electricalNodePropertiesSchema = new ConceptSchema(ELECTRICALNODEPROPERTIES);
    add(electricalNodePropertiesSchema, hygrid.globalDataModel.ontology.ElectricalNodeProperties.class);
    ConceptSchema triPhaseCableStateSchema = new ConceptSchema(TRIPHASECABLESTATE);
    add(triPhaseCableStateSchema, hygrid.globalDataModel.ontology.TriPhaseCableState.class);
    ConceptSchema pipeStateSchema = new ConceptSchema(PIPESTATE);
    add(pipeStateSchema, hygrid.globalDataModel.ontology.PipeState.class);
    ConceptSchema redTrafficLightSchema = new ConceptSchema(REDTRAFFICLIGHT);
    add(redTrafficLightSchema, hygrid.globalDataModel.ontology.RedTrafficLight.class);
    ConceptSchema transformerNodePropertiesSchema = new ConceptSchema(TRANSFORMERNODEPROPERTIES);
    add(transformerNodePropertiesSchema, hygrid.globalDataModel.ontology.TransformerNodeProperties.class);
    ConceptSchema uniPhaseCableStateSchema = new ConceptSchema(UNIPHASECABLESTATE);
    add(uniPhaseCableStateSchema, hygrid.globalDataModel.ontology.UniPhaseCableState.class);
    ConceptSchema electricalNodeStateSchema = new ConceptSchema(ELECTRICALNODESTATE);
    add(electricalNodeStateSchema, hygrid.globalDataModel.ontology.ElectricalNodeState.class);
    ConceptSchema remoteAgentInformationSchema = new ConceptSchema(REMOTEAGENTINFORMATION);
    add(remoteAgentInformationSchema, hygrid.globalDataModel.ontology.RemoteAgentInformation.class);
    ConceptSchema electricalPowerSchema = new ConceptSchema(ELECTRICALPOWER);
    add(electricalPowerSchema, hygrid.globalDataModel.ontology.ElectricalPower.class);
    ConceptSchema heatNodeStateSchema = new ConceptSchema(HEATNODESTATE);
    add(heatNodeStateSchema, hygrid.globalDataModel.ontology.HeatNodeState.class);
    ConceptSchema amberTrafficLightSchema = new ConceptSchema(AMBERTRAFFICLIGHT);
    add(amberTrafficLightSchema, hygrid.globalDataModel.ontology.AmberTrafficLight.class);
    ConceptSchema sensorPropertiesSchema = new ConceptSchema(SENSORPROPERTIES);
    add(sensorPropertiesSchema, hygrid.globalDataModel.ontology.SensorProperties.class);
    ConceptSchema triPhaseSensorStateSchema = new ConceptSchema(TRIPHASESENSORSTATE);
    add(triPhaseSensorStateSchema, hygrid.globalDataModel.ontology.TriPhaseSensorState.class);
    ConceptSchema reactivePowerSchema = new ConceptSchema(REACTIVEPOWER);
    add(reactivePowerSchema, hygrid.globalDataModel.ontology.ReactivePower.class);
    ConceptSchema greenTrafficLightSchema = new ConceptSchema(GREENTRAFFICLIGHT);
    add(greenTrafficLightSchema, hygrid.globalDataModel.ontology.GreenTrafficLight.class);
    ConceptSchema cablePropertiesSchema = new ConceptSchema(CABLEPROPERTIES);
    add(cablePropertiesSchema, hygrid.globalDataModel.ontology.CableProperties.class);
    ConceptSchema edgeComponentStateSchema = new ConceptSchema(EDGECOMPONENTSTATE);
    add(edgeComponentStateSchema, hygrid.globalDataModel.ontology.EdgeComponentState.class);
    ConceptSchema cableWithBreakerPropertiesSchema = new ConceptSchema(CABLEWITHBREAKERPROPERTIES);
    add(cableWithBreakerPropertiesSchema, hygrid.globalDataModel.ontology.CableWithBreakerProperties.class);
    ConceptSchema powerSchema = new ConceptSchema(POWER);
    add(powerSchema, hygrid.globalDataModel.ontology.Power.class);
    ConceptSchema uniPhaseSensorStateSchema = new ConceptSchema(UNIPHASESENSORSTATE);
    add(uniPhaseSensorStateSchema, hygrid.globalDataModel.ontology.UniPhaseSensorState.class);
    ConceptSchema cableStateSchema = new ConceptSchema(CABLESTATE);
    add(cableStateSchema, hygrid.globalDataModel.ontology.CableState.class);
    ConceptSchema pipeSurroundingEarthSchema = new ConceptSchema(PIPESURROUNDINGEARTH);
    add(pipeSurroundingEarthSchema, hygrid.globalDataModel.ontology.PipeSurroundingEarth.class);
    ConceptSchema uniPhaseElectricalNodeStateSchema = new ConceptSchema(UNIPHASEELECTRICALNODESTATE);
    add(uniPhaseElectricalNodeStateSchema, hygrid.globalDataModel.ontology.UniPhaseElectricalNodeState.class);
    ConceptSchema circuitBreakerSchema = new ConceptSchema(CIRCUITBREAKER);
    add(circuitBreakerSchema, hygrid.globalDataModel.ontology.CircuitBreaker.class);
    ConceptSchema longValueSchema = new ConceptSchema(LONGVALUE);
    add(longValueSchema, hygrid.globalDataModel.ontology.LongValue.class);
    ConceptSchema heatPipeStateSchema = new ConceptSchema(HEATPIPESTATE);
    add(heatPipeStateSchema, hygrid.globalDataModel.ontology.HeatPipeState.class);
    ConceptSchema twinHeatNodeStateSchema = new ConceptSchema(TWINHEATNODESTATE);
    add(twinHeatNodeStateSchema, hygrid.globalDataModel.ontology.TwinHeatNodeState.class);
    ConceptSchema dynamicComponentStateSchema = new ConceptSchema(DYNAMICCOMPONENTSTATE);
    add(dynamicComponentStateSchema, hygrid.globalDataModel.ontology.DynamicComponentState.class);
    ConceptSchema triPhaseElectricalNodeStateSchema = new ConceptSchema(TRIPHASEELECTRICALNODESTATE);
    add(triPhaseElectricalNodeStateSchema, hygrid.globalDataModel.ontology.TriPhaseElectricalNodeState.class);

    // adding AgentAction(s)
    AgentActionSchema gridStateViolationSchema = new AgentActionSchema(GRIDSTATEVIOLATION);
    add(gridStateViolationSchema, hygrid.globalDataModel.ontology.GridStateViolation.class);
    AgentActionSchema flexibilityOfferSchema = new AgentActionSchema(FLEXIBILITYOFFER);
    add(flexibilityOfferSchema, hygrid.globalDataModel.ontology.FlexibilityOffer.class);
    AgentActionSchema proxyAgentRegistrationRequestSchema = new AgentActionSchema(PROXYAGENTREGISTRATIONREQUEST);
    add(proxyAgentRegistrationRequestSchema, hygrid.globalDataModel.ontology.ProxyAgentRegistrationRequest.class);
    AgentActionSchema physicalSchema = new AgentActionSchema(PHYSICAL);
    add(physicalSchema, hygrid.globalDataModel.ontology.Physical.class);
    AgentActionSchema electricalGridStateUpdateSchema = new AgentActionSchema(ELECTRICALGRIDSTATEUPDATE);
    add(electricalGridStateUpdateSchema, hygrid.globalDataModel.ontology.ElectricalGridStateUpdate.class);
    AgentActionSchema voltageBandInformationSchema = new AgentActionSchema(VOLTAGEBANDINFORMATION);
    add(voltageBandInformationSchema, hygrid.globalDataModel.ontology.VoltageBandInformation.class);
    AgentActionSchema gasMeasurementSchema = new AgentActionSchema(GASMEASUREMENT);
    add(gasMeasurementSchema, hygrid.globalDataModel.ontology.GasMeasurement.class);
    AgentActionSchema remoteAgentRegistrationRequestSchema = new AgentActionSchema(REMOTEAGENTREGISTRATIONREQUEST);
    add(remoteAgentRegistrationRequestSchema, hygrid.globalDataModel.ontology.RemoteAgentRegistrationRequest.class);
    AgentActionSchema gridStateAgentManagementSchema = new AgentActionSchema(GRIDSTATEAGENTMANAGEMENT);
    add(gridStateAgentManagementSchema, hygrid.globalDataModel.ontology.GridStateAgentManagement.class);
    AgentActionSchema gridStateAssessmentInformationSchema = new AgentActionSchema(GRIDSTATEASSESSMENTINFORMATION);
    add(gridStateAssessmentInformationSchema, hygrid.globalDataModel.ontology.GridStateAssessmentInformation.class);
    AgentActionSchema gridStateControlSchema = new AgentActionSchema(GRIDSTATECONTROL);
    add(gridStateControlSchema, hygrid.globalDataModel.ontology.GridStateControl.class);
    AgentActionSchema requestValuesSchema = new AgentActionSchema(REQUESTVALUES);
    add(requestValuesSchema, hygrid.globalDataModel.ontology.RequestValues.class);
    AgentActionSchema testbedAgentManagementSchema = new AgentActionSchema(TESTBEDAGENTMANAGEMENT);
    add(testbedAgentManagementSchema, hygrid.globalDataModel.ontology.TestbedAgentManagement.class);
    AgentActionSchema weatherDataUpdateSchema = new AgentActionSchema(WEATHERDATAUPDATE);
    add(weatherDataUpdateSchema, hygrid.globalDataModel.ontology.WeatherDataUpdate.class);
    AgentActionSchema measurementSchema = new AgentActionSchema(MEASUREMENT);
    add(measurementSchema, hygrid.globalDataModel.ontology.Measurement.class);
    AgentActionSchema modbusAdapterActionSchema = new AgentActionSchema(MODBUSADAPTERACTION);
    add(modbusAdapterActionSchema, hygrid.globalDataModel.ontology.ModbusAdapterAction.class);
    AgentActionSchema ceaRegistrationResponseSchema = new AgentActionSchema(CEAREGISTRATIONRESPONSE);
    add(ceaRegistrationResponseSchema, hygrid.globalDataModel.ontology.CEARegistrationResponse.class);
    AgentActionSchema slackNodeSetVoltageLevelNotificationSchema = new AgentActionSchema(SLACKNODESETVOLTAGELEVELNOTIFICATION);
    add(slackNodeSetVoltageLevelNotificationSchema, hygrid.globalDataModel.ontology.SlackNodeSetVoltageLevelNotification.class);
    AgentActionSchema setModbusSetpointsSchema = new AgentActionSchema(SETMODBUSSETPOINTS);
    add(setModbusSetpointsSchema, hygrid.globalDataModel.ontology.SetModbusSetpoints.class);
    AgentActionSchema referencePVMeasurementUpdateSchema = new AgentActionSchema(REFERENCEPVMEASUREMENTUPDATE);
    add(referencePVMeasurementUpdateSchema, hygrid.globalDataModel.ontology.ReferencePVMeasurementUpdate.class);
    AgentActionSchema electricalMeasurementSchema = new AgentActionSchema(ELECTRICALMEASUREMENT);
    add(electricalMeasurementSchema, hygrid.globalDataModel.ontology.ElectricalMeasurement.class);
