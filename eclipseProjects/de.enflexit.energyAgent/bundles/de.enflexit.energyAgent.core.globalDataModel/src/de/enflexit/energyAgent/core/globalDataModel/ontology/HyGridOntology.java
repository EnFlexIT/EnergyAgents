...
public class HyGridOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String PHYSICAL_TIMESTAMP="timeStamp";
  ...
  */
  private HyGridOntology(){ 
    ...
    add(cableWithBreakerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CableWithBreaker.class);
    ConceptSchema unitValueSchema = new ConceptSchema(UNITVALUE);
    add(unitValueSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UnitValue.class);
    ConceptSchema triPhaseElectricalTransformerStateSchema = new ConceptSchema(TRIPHASEELECTRICALTRANSFORMERSTATE);
    add(triPhaseElectricalTransformerStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TriPhaseElectricalTransformerState.class);
    ConceptSchema staticComponentPropertiesSchema = new ConceptSchema(STATICCOMPONENTPROPERTIES);
    add(staticComponentPropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.StaticComponentProperties.class);
    ConceptSchema gridStateAssessmentSchema = new ConceptSchema(GRIDSTATEASSESSMENT);
    add(gridStateAssessmentSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GridStateAssessment.class);
    ConceptSchema voltageBandSchema = new ConceptSchema(VOLTAGEBAND);
    add(voltageBandSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.VoltageBand.class);
    ConceptSchema uniPhaseElectricalTransformerStateSchema = new ConceptSchema(UNIPHASEELECTRICALTRANSFORMERSTATE);
    add(uniPhaseElectricalTransformerStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UniPhaseElectricalTransformerState.class);
    ConceptSchema pipePropertiesSchema = new ConceptSchema(PIPEPROPERTIES);
    add(pipePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.PipeProperties.class);
    ConceptSchema twinPipeStateSchema = new ConceptSchema(TWINPIPESTATE);
    add(twinPipeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TwinPipeState.class);
    ConceptSchema gasNodeStateSchema = new ConceptSchema(GASNODESTATE);
    add(gasNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GasNodeState.class);
    ConceptSchema fluidNodeStateSchema = new ConceptSchema(FLUIDNODESTATE);
    add(fluidNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.FluidNodeState.class);
    ConceptSchema activePowerSchema = new ConceptSchema(ACTIVEPOWER);
    add(activePowerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ActivePower.class);
    ConceptSchema weatherDataSchema = new ConceptSchema(WEATHERDATA);
    add(weatherDataSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.WeatherData.class);
    ConceptSchema nodeComponentStateSchema = new ConceptSchema(NODECOMPONENTSTATE);
    add(nodeComponentStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.NodeComponentState.class);
    ConceptSchema electricalGridStateSchema = new ConceptSchema(ELECTRICALGRIDSTATE);
    add(electricalGridStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalGridState.class);
    ConceptSchema doubleValueSchema = new ConceptSchema(DOUBLEVALUE);
    add(doubleValueSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.DoubleValue.class);
    ConceptSchema trafficLightSchema = new ConceptSchema(TRAFFICLIGHT);
    add(trafficLightSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TrafficLight.class);
    ConceptSchema uniPhaseCableWithBreakerSchema = new ConceptSchema(UNIPHASECABLEWITHBREAKER);
    add(uniPhaseCableWithBreakerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UniPhaseCableWithBreaker.class);
    ConceptSchema pipeSurroundingAirSchema = new ConceptSchema(PIPESURROUNDINGAIR);
    add(pipeSurroundingAirSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.PipeSurroundingAir.class);
    ConceptSchema heatPipePropertiesSchema = new ConceptSchema(HEATPIPEPROPERTIES);
    add(heatPipePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.HeatPipeProperties.class);
    ConceptSchema pipeSurroundingSchema = new ConceptSchema(PIPESURROUNDING);
    add(pipeSurroundingSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.PipeSurrounding.class);
    ConceptSchema modbusSetpointSchema = new ConceptSchema(MODBUSSETPOINT);
    add(modbusSetpointSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ModbusSetpoint.class);
    ConceptSchema nodeComponentPropertiesSchema = new ConceptSchema(NODECOMPONENTPROPERTIES);
    add(nodeComponentPropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.NodeComponentProperties.class);
    ConceptSchema cableSchema = new ConceptSchema(CABLE);
    add(cableSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.Cable.class);
    ConceptSchema heatNodePropertiesSchema = new ConceptSchema(HEATNODEPROPERTIES);
    add(heatNodePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.HeatNodeProperties.class);
    ConceptSchema sensorSchema = new ConceptSchema(SENSOR);
    add(sensorSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.Sensor.class);
    ConceptSchema edgeComponentPropertiesSchema = new ConceptSchema(EDGECOMPONENTPROPERTIES);
    add(edgeComponentPropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.EdgeComponentProperties.class);
    ConceptSchema electricalNodePropertiesSchema = new ConceptSchema(ELECTRICALNODEPROPERTIES);
    add(electricalNodePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalNodeProperties.class);
    ConceptSchema triPhaseCableStateSchema = new ConceptSchema(TRIPHASECABLESTATE);
    add(triPhaseCableStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TriPhaseCableState.class);
    ConceptSchema pipeStateSchema = new ConceptSchema(PIPESTATE);
    add(pipeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.PipeState.class);
    ConceptSchema redTrafficLightSchema = new ConceptSchema(REDTRAFFICLIGHT);
    add(redTrafficLightSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.RedTrafficLight.class);
    ConceptSchema transformerNodePropertiesSchema = new ConceptSchema(TRANSFORMERNODEPROPERTIES);
    add(transformerNodePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TransformerNodeProperties.class);
    ConceptSchema uniPhaseCableStateSchema = new ConceptSchema(UNIPHASECABLESTATE);
    add(uniPhaseCableStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UniPhaseCableState.class);
    ConceptSchema electricalNodeStateSchema = new ConceptSchema(ELECTRICALNODESTATE);
    add(electricalNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalNodeState.class);
    ConceptSchema remoteAgentInformationSchema = new ConceptSchema(REMOTEAGENTINFORMATION);
    add(remoteAgentInformationSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.RemoteAgentInformation.class);
    ConceptSchema electricalPowerSchema = new ConceptSchema(ELECTRICALPOWER);
    add(electricalPowerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalPower.class);
    ConceptSchema heatNodeStateSchema = new ConceptSchema(HEATNODESTATE);
    add(heatNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.HeatNodeState.class);
    ConceptSchema amberTrafficLightSchema = new ConceptSchema(AMBERTRAFFICLIGHT);
    add(amberTrafficLightSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.AmberTrafficLight.class);
    ConceptSchema sensorPropertiesSchema = new ConceptSchema(SENSORPROPERTIES);
    add(sensorPropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.SensorProperties.class);
    ConceptSchema triPhaseSensorStateSchema = new ConceptSchema(TRIPHASESENSORSTATE);
    add(triPhaseSensorStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TriPhaseSensorState.class);
    ConceptSchema reactivePowerSchema = new ConceptSchema(REACTIVEPOWER);
    add(reactivePowerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ReactivePower.class);
    ConceptSchema greenTrafficLightSchema = new ConceptSchema(GREENTRAFFICLIGHT);
    add(greenTrafficLightSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GreenTrafficLight.class);
    ConceptSchema cablePropertiesSchema = new ConceptSchema(CABLEPROPERTIES);
    add(cablePropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CableProperties.class);
    ConceptSchema edgeComponentStateSchema = new ConceptSchema(EDGECOMPONENTSTATE);
    add(edgeComponentStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.EdgeComponentState.class);
    ConceptSchema cableWithBreakerPropertiesSchema = new ConceptSchema(CABLEWITHBREAKERPROPERTIES);
    add(cableWithBreakerPropertiesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CableWithBreakerProperties.class);
    ConceptSchema powerSchema = new ConceptSchema(POWER);
    add(powerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.Power.class);
    ConceptSchema uniPhaseSensorStateSchema = new ConceptSchema(UNIPHASESENSORSTATE);
    add(uniPhaseSensorStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UniPhaseSensorState.class);
    ConceptSchema cableStateSchema = new ConceptSchema(CABLESTATE);
    add(cableStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CableState.class);
    ConceptSchema pipeSurroundingEarthSchema = new ConceptSchema(PIPESURROUNDINGEARTH);
    add(pipeSurroundingEarthSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.PipeSurroundingEarth.class);
    ConceptSchema uniPhaseElectricalNodeStateSchema = new ConceptSchema(UNIPHASEELECTRICALNODESTATE);
    add(uniPhaseElectricalNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.UniPhaseElectricalNodeState.class);
    ConceptSchema circuitBreakerSchema = new ConceptSchema(CIRCUITBREAKER);
    add(circuitBreakerSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CircuitBreaker.class);
    ConceptSchema longValueSchema = new ConceptSchema(LONGVALUE);
    add(longValueSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.LongValue.class);
    ConceptSchema heatPipeStateSchema = new ConceptSchema(HEATPIPESTATE);
    add(heatPipeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.HeatPipeState.class);
    ConceptSchema twinHeatNodeStateSchema = new ConceptSchema(TWINHEATNODESTATE);
    add(twinHeatNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TwinHeatNodeState.class);
    ConceptSchema dynamicComponentStateSchema = new ConceptSchema(DYNAMICCOMPONENTSTATE);
    add(dynamicComponentStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.DynamicComponentState.class);
    ConceptSchema triPhaseElectricalNodeStateSchema = new ConceptSchema(TRIPHASEELECTRICALNODESTATE);
    add(triPhaseElectricalNodeStateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TriPhaseElectricalNodeState.class);

    // adding AgentAction(s)
    AgentActionSchema gridStateViolationSchema = new AgentActionSchema(GRIDSTATEVIOLATION);
    add(gridStateViolationSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GridStateViolation.class);
    AgentActionSchema flexibilityOfferSchema = new AgentActionSchema(FLEXIBILITYOFFER);
    add(flexibilityOfferSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.FlexibilityOffer.class);
    AgentActionSchema proxyAgentRegistrationRequestSchema = new AgentActionSchema(PROXYAGENTREGISTRATIONREQUEST);
    add(proxyAgentRegistrationRequestSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ProxyAgentRegistrationRequest.class);
    AgentActionSchema physicalSchema = new AgentActionSchema(PHYSICAL);
    add(physicalSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.Physical.class);
    AgentActionSchema electricalGridStateUpdateSchema = new AgentActionSchema(ELECTRICALGRIDSTATEUPDATE);
    add(electricalGridStateUpdateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalGridStateUpdate.class);
    AgentActionSchema voltageBandInformationSchema = new AgentActionSchema(VOLTAGEBANDINFORMATION);
    add(voltageBandInformationSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.VoltageBandInformation.class);
    AgentActionSchema gasMeasurementSchema = new AgentActionSchema(GASMEASUREMENT);
    add(gasMeasurementSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GasMeasurement.class);
    AgentActionSchema remoteAgentRegistrationRequestSchema = new AgentActionSchema(REMOTEAGENTREGISTRATIONREQUEST);
    add(remoteAgentRegistrationRequestSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.RemoteAgentRegistrationRequest.class);
    AgentActionSchema gridStateAgentManagementSchema = new AgentActionSchema(GRIDSTATEAGENTMANAGEMENT);
    add(gridStateAgentManagementSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GridStateAgentManagement.class);
    AgentActionSchema gridStateAssessmentInformationSchema = new AgentActionSchema(GRIDSTATEASSESSMENTINFORMATION);
    add(gridStateAssessmentInformationSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GridStateAssessmentInformation.class);
    AgentActionSchema gridStateControlSchema = new AgentActionSchema(GRIDSTATECONTROL);
    add(gridStateControlSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.GridStateControl.class);
    AgentActionSchema requestValuesSchema = new AgentActionSchema(REQUESTVALUES);
    add(requestValuesSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.RequestValues.class);
    AgentActionSchema testbedAgentManagementSchema = new AgentActionSchema(TESTBEDAGENTMANAGEMENT);
    add(testbedAgentManagementSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.TestbedAgentManagement.class);
    AgentActionSchema weatherDataUpdateSchema = new AgentActionSchema(WEATHERDATAUPDATE);
    add(weatherDataUpdateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.WeatherDataUpdate.class);
    AgentActionSchema measurementSchema = new AgentActionSchema(MEASUREMENT);
    add(measurementSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.Measurement.class);
    AgentActionSchema modbusAdapterActionSchema = new AgentActionSchema(MODBUSADAPTERACTION);
    add(modbusAdapterActionSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ModbusAdapterAction.class);
    AgentActionSchema ceaRegistrationResponseSchema = new AgentActionSchema(CEAREGISTRATIONRESPONSE);
    add(ceaRegistrationResponseSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.CEARegistrationResponse.class);
    AgentActionSchema slackNodeSetVoltageLevelNotificationSchema = new AgentActionSchema(SLACKNODESETVOLTAGELEVELNOTIFICATION);
    add(slackNodeSetVoltageLevelNotificationSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.SlackNodeSetVoltageLevelNotification.class);
    AgentActionSchema setModbusSetpointsSchema = new AgentActionSchema(SETMODBUSSETPOINTS);
    add(setModbusSetpointsSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.SetModbusSetpoints.class);
    AgentActionSchema referencePVMeasurementUpdateSchema = new AgentActionSchema(REFERENCEPVMEASUREMENTUPDATE);
    add(referencePVMeasurementUpdateSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ReferencePVMeasurementUpdate.class);
    AgentActionSchema electricalMeasurementSchema = new AgentActionSchema(ELECTRICALMEASUREMENT);
    add(electricalMeasurementSchema, de.enflexit.energyAgent.core.globalDataModel.ontology.ElectricalMeasurement.class);
    ...
    physicalSchema.add(PHYSICAL_TIMESTAMP, longValueSchema, ObjectSchema.OPTIONAL);
    ...
    voltageBandInformationSchema.addSuperSchema(physicalSchema);
    ...
    gridStateAssessmentInformationSchema.addSuperSchema(physicalSchema);
    ...
    measurementSchema.addSuperSchema(physicalSchema);
    ceaRegistrationResponseSchema.addSuperSchema(testbedAgentManagementSchema);
    slackNodeSetVoltageLevelNotificationSchema.addSuperSchema(physicalSchema);
